...
const PARTNER_LOGOS = [
  ...
  { src: '/images/partner-bgf.svg', alt: 'BGF Retail', size: 'h-7 sm:h-8', mobileScale: '0.8' },
          ...
          {PARTNER_LOGOS.map((logo) => (
            ...
            >
              ...
              <img
                src={logo.src}
                alt={logo.alt}
                className={`${logo.size} w-auto max-w-[120px] select-none object-contain opacity-100 transition-all duration-300 hover:scale-[1.03] max-[768px]:max-w-[140px] max-[768px]:h-auto${logo.mobileScale ? ` max-[768px]:scale-[${logo.mobileScale}]` : ''}`}
                draggable={false}
              />
            </motion.div>
          ))}
